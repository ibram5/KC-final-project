...
def file_sorter():
    ...
    for file in files:
        ...
        elif file_exe in Word_files:
            dest = "../Word files"
            shutil.move(file,dest)   
            
        elif file_exe in videos:
            dest ="../Videos"
            shutil.move(file,dest)
                
        elif file_exe in applications:
            dest ="../Apps"
            shutil.move(file,dest)  
        
        elif file_exe in music:
            dest ="../Music"    
            shutil.move(file,dest)
                
        elif file_exe in pdf:
            dest="../pdf files"
            shutil.move(file,dest)
...
button =tk.Button(root , text="sort files"  , font=("Arial" , 14) ,command=file_sorter) 
